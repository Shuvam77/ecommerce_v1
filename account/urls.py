...
urlpatterns = [
    ...
    path('password_reset_confirm/MQ/password_reset_complete/', TemplateView.as_view(template_name='account/password_reset/reset_status.html'), name='password_reset_complete'),
    ...
    path('profile/delete/<int:id>/', views.delete_user, name='delete_user'),
