...
class ProductType(models.Model):
    ...
    name = models.CharField(
        verbose_name=_("Product Name"), help_text=_("Required Field!"), max_length=255, unique=True
    )
    is_active = models.BooleanField(default=True)
...
class ProductSpecification(models.Model):
    ...
    name = models.CharField(verbose_name=_("Name"), help_text=_("Required Field!"), max_length=255)
...
class Product(models.Model):
    ...
    title = models.CharField(verbose_name=_("Title"), help_text=_("Required Field!"), max_length=255)
    description = models.TextField(verbose_name=_("Description"), help_text=_("Not Compulsory!"), blank=True)
    ...
    regular_price = models.DecimalField(
        ...
        error_messages={
            "name": {
                "max_length": _("The price must be betweeb 0 and 999.99"),
            },
        },
        max_digits=5,
        decimal_places=2,
...
class ProductImage(models.Model):
    ...
    image = models.ImageField(
        ...
        upload_to="images/",
        default="images/No_image_available.png",
    )
